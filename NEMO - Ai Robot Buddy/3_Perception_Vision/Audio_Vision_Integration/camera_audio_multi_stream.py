"""
Description: Multiple audio streams with camera
...
audio_files = [
    ...
    #"/home/nisan/Desktop/another_audio.mp3",
    #"/home/nisan/Desktop/audio3.mp3"
...
def play_audio():
    """Play a random audio file using cvlc"""
    try:
        audio_file = random.choice(audio_files)  # Randomly choose an audio file
        subprocess.run(["cvlc", "--play-and-exit", audio_file])  # Play selected audio
    except Exception as e:
